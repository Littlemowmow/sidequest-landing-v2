        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/30">
              <li><button onClick={() => scrollToSection("features")} className="hover:text-orange-400 transition-colors focus-visible:outline-none focus-visible:text-orange-400" data-testid="link-footer-features">Features</button></li>
              <li><button onClick={() => scrollToSection("demo")} className="hover:text-orange-400 transition-colors focus-visible:outline-none focus-visible:text-orange-400" data-testid="link-footer-demo">Demo</button></li>
              <li><button onClick={() => scrollToSection("cities")} className="hover:text-orange-400 transition-colors focus-visible:outline-none focus-visible:text-orange-400" data-testid="link-footer-cities">Launch Cities</button></li>
            </ul>
          </div>
